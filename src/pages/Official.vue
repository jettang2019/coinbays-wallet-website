...
.official-page {
  ...
  .bg1 {
    background: linear-gradient(180deg, #E5E5F2 0%, #EFEFF8 100%);;
  ...
  .header {
    ...
    .middle-wrapper {
      ...
      .download-container img:first-child {
        margin-right: 15px;
      }
    }
